...
const Newsletter = () => {
  return (
    <div className="flex flex-col justify-center items-center border-2 gap-2 border-gray-300 rounded-lg p-8 m-4">
      ...
      <div className="flex justify-center items-center flex-col">
        ...
        />
        <button className="bg-green-600 text-white py-2 px-4 rounded-lg m-2">
          Subscribe
        </button>
      </div>
    </div>
